...
class Button:
    def __init__(self, text, results):
        ...
        self.b.clicked.connect(lambda: self.handel_input(self.text))

    def handel_input(self, v):
        if v == "=":
...
class Application(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Ratul's Calculator")
        self.create_app()
    ...
    def create_app(self):
        ...
        grid.addWidget(input_text, 0, 0, 1, 4)
        ...
        for button in buttons:
            ...
            button_object = Button(button, input_text)
